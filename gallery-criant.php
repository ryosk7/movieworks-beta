      ...
      <div class="wrapper">
        <section class="mainContent">
          ...
          <div class="prof-body">
            ...
            <a href="http://localhost/movieworks-beta/gallery-criant-sinsei.php">
              <input type="button" id="form_submit_button" value="  この人にマッチング申請を送る  " />
            </a>
            <br>

            <input type="button" id="form_submit_button" value="  ギャラリーに戻る  " />
