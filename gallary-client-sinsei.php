<?php
 ...
 $cl_pic = $_SESSION['cl_pic'];
 $cl_email = $_SESSION['cl_email'];
 ...
 if (isset($_POST['request'])) {
   $mvid = "aaaaaaaaaa";
   // echo "Hello World";
   $client = $pdo -> prepare  ("INSERT INTO client(name, email, picture, mvid)values(?,?,?,?)");
   $client -> bindParam("name",$cl_name);
   $client -> bindParam("email",$cl_email);
   $client -> bindParam("picture",$cl_pic);
   $client -> bindParam("mvid",$mvid);

   $client -> execute(array($cl_name,$cl_email,$cl_pic,$mvid));
       ...
       <div class="wrapper">
         <section class="mainContent">
           ...
           <div class="prof-body">
             ...
             <div class="prof-icon">
               <img src=<?php echo $cl_pic; ?> style="margin-top:100px;" alt="">
               <h3 class="prof-title"><?php echo $cl_name; ?></h3>
